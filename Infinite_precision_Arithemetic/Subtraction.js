...
// Testing Function
function Test() {
  console.log(subtraction([ 1], [6, 0]));
  console.log(subtraction([4, 6, 2], [1, 7, 4, 2]));
  console.log(subtraction([6, 0, 1, 5], [7, 3, 5, 2]));
  console.log(subtraction([4, 6, 5, 9], [5, 9, 2]));
  console.log(subtraction([3, 6, 1, 2, 3, 9, 3], [6, 3, 1, 2, 8, 5, 2]));
  console.log(subtraction([7, 8, 9], [1, 1, 8, 5]));  
	console.log(subtraction([], [4, 8, 2]));
}
Test();
